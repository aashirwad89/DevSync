  ...
  if (loading) return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-950 to-gray-900 flex items-center justify-center" style={{ fontFamily: "'JetBrains Mono', 'Courier New', monospace" }}>
      <div className="text-center">
        <div className="text-5xl animate-pulse text-emerald-400 mb-3">⬡</div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-950 to-gray-900 text-white transition-colors duration-300" style={{ fontFamily: "'JetBrains Mono', 'Courier New', monospace" }}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-40 right-40 w-96 h-96 bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-full blur-3xl opacity-40 animate-pulse"></div>
        <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-gradient-to-tr from-blue-500/10 to-emerald-500/10 rounded-full blur-3xl opacity-40 animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <nav className="sticky top-0 z-30 backdrop-blur-xl bg-gray-950/80 border-b border-gray-800/30 px-6 py-5 flex items-center justify-between transition-all duration-300">
        <div className="flex items-center gap-3 group cursor-pointer hover:scale-105 transition-transform">
          <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-lg flex items-center justify-center font-black text-gray-950 shadow-lg shadow-emerald-500/30">
            ⬡
          </div>
          <div>
            <span className="font-black tracking-widest uppercase text-lg bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">DevSync</span>
          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
              ...
              <div className="flex items-start gap-6 flex-1">
                <div className="w-24 h-24 bg-gradient-to-br from-emerald-500/30 to-cyan-500/30 border-2 border-emerald-500/40 rounded-2xl flex items-center justify-center text-5xl font-black text-emerald-400 shadow-lg shadow-emerald-500/20 flex-shrink-0 group hover:scale-110 transition-transform duration-300">
        ...
        <div className="mb-16 animate-fade-in" style={{ animationDelay: '200ms' }}>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold">{repos.length}</span>
            </div>
            <button
              onClick={() => navigate('/repo')}
              className="text-emerald-400 hover:text-emerald-300 text-sm font-bold transition-colors duration-200 hover:underline"
            >
              View all →
            </button>
          </div>
          ...
          {repos.length === 0 ? (
            <div className="text-center py-20 border-2 border-dashed border-gray-800/50 rounded-2xl transition-all duration-300 hover:border-emerald-500/30 hover:bg-emerald-500/5">
              ...
              {repos.map((repo, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 border border-emerald-500/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <span className="text-emerald-400 text-lg">◈</span>
                    </div>
                  ...
                  <h3 className="text-white font-bold text-lg mb-2 group-hover:text-emerald-400 transition-colors duration-300">
                    {repo.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    ...
                    <span className="text-gray-700 group-hover:text-emerald-400 transition-colors duration-300">→</span>
                  </div>
                </div>
              ))}
            </div>
