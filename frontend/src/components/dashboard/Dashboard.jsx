      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 relative z-10">
          ...
          <div className={`${card} border ${d ? 'border-gray-800/50' : 'border-gray-200/50'} rounded-2xl p-6 mb-16 animate-fade-in`} style={{ animationDelay: '200ms' }}>
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className={`text-emerald-400 text-sm font-bold`}>{Math.round((inProgressIssues / issues.length) * 100 || 0)}% of total</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={() => navigate('/repo')} className="text-emerald-400 hover:text-emerald-300 text-xs font-bold transition-colors duration-200 hover:underline">
              View all →
            </button>
          </div>
              ...
              {repositories.slice(0, 4).map((repo, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 flex-shrink-0 ml-4">
                    ...
                    <span className={`${muted} group-hover:text-emerald-400 transition-all duration-300 text-lg group-hover:translate-x-1`}>→</span>
                  </div>
                </div>
              ))}
            </div>
