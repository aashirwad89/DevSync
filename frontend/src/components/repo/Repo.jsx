      ...
      <nav className={`${navBg} border-b ${d ? 'border-gray-800/30' : 'border-gray-200/30'} px-6 py-5 flex items-center justify-between sticky top-0 z-30 transition-all duration-300`}>
        <div className="flex items-center gap-4">
          <button 
            ...
            className={`${muted} hover:text-emerald-400 text-sm font-bold transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-emerald-500/10`}
          >
            ← Dashboard
          </button>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center font-black text-gray-950 shadow-lg shadow-emerald-500/30">
              ◈
            </div>
            <span className={`font-black tracking-widest uppercase text-lg bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent`}>Repositories</span>
          </div>
        </div>
